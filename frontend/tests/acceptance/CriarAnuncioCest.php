...
class CriarAnuncioCest
{
    ...
    /*public function checkCriarAnuncioTodos(FunctionalTester $I)
    {
        ...
        $I->fillField('AnuncioForm[quantOferta]', '3');
        $I->fillField('EletronicaForm[0][nome]', 'TesteFuncional');
        $I->fillField('EletronicaForm[0][marca]', 'TesteFuncional');
        $I->fillField('EletronicaForm[0][descricao]', 'TesteFuncional');

        $I->click('#field-cat-procura');
        $I->click('Todos');
        $I->see('Todos');

        $I->fillField('AnuncioForm[comentarios]', 'ComentariosTeste');
